...
<div class="hero" style="padding-bottom:1rem;">
  ...
  <p class="hero-tagline" style="font-size:1rem;">What we kept, what we skipped, and why.</p>
</div>
...
<span class="section-label" style="margin-top:2.5rem;">Considered, kept</span>
...
<span class="section-label" style="margin-top:2.5rem;">Considered, not adopted</span>
<h2>Controls We Evaluated and Skipped — And Why</h2>

<h3 style="margin-top:1.5rem;">1. Application-layer Certificate Pinning</h3>
...
<h3 style="margin-top:1.5rem;">2. Memory locking to prevent swap-to-disk</h3>
...
<h3 style="margin-top:1.5rem;">3. Redis TLS and password authentication</h3>
...
<h3 style="margin-top:1.5rem;">4. Circuit breakers between services</h3>
...
<h3 style="margin-top:1.5rem;">5. Third-party crash and analytics SDKs</h3>
