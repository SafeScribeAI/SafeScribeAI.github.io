...
<ul class="do-list">
  ...
  <li><span class="check-mark">&#x2713;</span><span class="item-body"><strong>Copia de seguridad diaria</strong><span class="item-desc">la copia sobrescrita a diario deja de contener sus datos identificativos tras el siguiente ciclo de copia (en 24 horas); una instantánea independiente de recuperación point-in-time, tomada en el momento de la eliminación, se conserva con fines de recuperación ante desastres y no se purga de inmediato</span></span></li>
</ul>

Todo vínculo con su identidad se destruye en el momento de la eliminación. Dos categorías limitadas persisten temporalmente <em>sin ningún vínculo de identidad</em>: los registros financieros (importes de compra y uso) se anonimizan al marcador DELETED_USER y se conservan 2 años conforme a la prescripción por servicios defectuosos (Ley turca de Protección del Consumidor, arts. 15-16); y un hash salado de dispositivo se conserva hasta 2 años para impedir la concesión repetida de créditos gratuitos (art. 6(1)(f) RGPD, interés legítimo). Ambos se purgan automáticamente del sistema activo al vencer el plazo. La copia de seguridad sobrescrita a diario deja de reflejar las cuentas eliminadas en 24 horas; no obstante, las instantáneas de recuperación point-in-time tomadas antes de una eliminación se conservan con fines de recuperación ante desastres y no se purgan de inmediato.
