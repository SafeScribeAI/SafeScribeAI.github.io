...
| 피드백 및 문제 보고 | 자유 입력 텍스트(서버 측에서 개인정보 제거됨) + 가명 사용자 해시; 보고 유형 및 앱 진단 정보 | 제6조(1)(a) — 동의 | 명시적 동의 |
...
| 피드백 및 문제 보고(선택 가입) | 개인정보가 제거된 자유 입력 텍스트 + 가명 사용자 해시만 — 최대 24개월간 보존된 후 자동 삭제 |
...
| 전송 중 전사본에 대한 무단 접근 | 중간 | TLS 1.3; SHA-256 무결성 체크섬 | **낮음** |
