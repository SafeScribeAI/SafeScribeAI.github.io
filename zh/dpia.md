...
1. 用户在设备上录制或选择音频
2. 设备端音频预处理（200 Hz 高通滤波器、前置静音修剪、-16 LUFS 响度归一化、峰值限制、16 kHz 重采样、FLAC 编码）
3. 加密上传至 SafeScribe 服务器（TLS 1.2+）
